...
public class MysqlTypeMapperRule implements IDataTypeMapperRule {
    ...
    static{
        ...
        dbToJavaTypeMap.put("TEXT",String.class);
        dbToJavaTypeMap.put("LONGTEXT",String.class);
        ...
        dbToJavaTypeMap.put("INT",Integer.class);
        ...
        dbToJavaTypeMap.put("DATETIME",Date.class);
